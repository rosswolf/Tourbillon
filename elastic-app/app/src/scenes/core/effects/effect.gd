...
static var effect_map: Dictionary[String, InternalEffect] = {
	...
	"add_red_energy": color_signal("core_energy_filled", Air.AirColor.RED),
	"add_blue_energy": color_signal("core_energy_filled", Air.AirColor.BLUE),
	"add_orange_energy": color_signal("core_energy_filled", Air.AirColor.ORANGE),
	...
	"remove_red_energy":color_signal("core_energy_removed", Air.AirColor.RED),
	"remove_blue_energy": color_signal("core_energy_removed", Air.AirColor.BLUE),
	"remove_orange_energy": color_signal("core_energy_removed", Air.AirColor.ORANGE),
	...
	"add_red_time": color_signal("core_time_filled", Air.AirColor.RED),
	"add_blue_time": color_signal("core_time_filled", Air.AirColor.BLUE),
	"add_orange_time": color_signal("core_time_filled", Air.AirColor.ORANGE),
	...
	"remove_red_time": color_signal("core_time_removed", Air.AirColor.RED),
	"remove_blue_time": color_signal("core_time_removed", Air.AirColor.BLUE),
	"remove_orange_time": color_signal("core_time_removed", Air.AirColor.ORANGE),
