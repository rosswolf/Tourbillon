...
static var effect_map: Dictionary[String, InternalEffect] = {
	...
	"add_purple_energy": color_signal("core_energy_filled", Air.AirColor.PURPLE),
	"add_blue_energy": color_signal("core_energy_filled", Air.AirColor.BLUE),
	"add_green_energy": color_signal("core_energy_filled", Air.AirColor.GREEN),
	"set_purple_energy":color_signal("core_energy_set", Air.AirColor.PURPLE),
	"set_blue_energy": color_signal("core_energy_set", Air.AirColor.BLUE),
	"set_green_energy": color_signal("core_energy_set", Air.AirColor.GREEN),
	"remove_purple_energy":color_signal("core_energy_removed", Air.AirColor.PURPLE),
	"remove_blue_energy": color_signal("core_energy_removed", Air.AirColor.BLUE),
	"remove_green_energy": color_signal("core_energy_removed", Air.AirColor.GREEN),
	"add_max_purple_energy": color_signal("core_max_energy_added", Air.AirColor.PURPLE),
	"add_max_blue_energy": color_signal("core_max_energy_added", Air.AirColor.BLUE),	
	"add_max_green_energy": color_signal("core_max_energy_added", Air.AirColor.GREEN),
	"set_max_purple_energy": color_signal("core_max_energy_set", Air.AirColor.PURPLE),
	"set_max_blue_energy": color_signal("core_max_energy_set", Air.AirColor.BLUE),	
	"set_max_green_energy": color_signal("core_max_energy_set", Air.AirColor.GREEN),
	
	"add_purple_time": color_signal("core_time_filled", Air.AirColor.PURPLE),
	"add_blue_time": color_signal("core_time_filled", Air.AirColor.BLUE),
	"add_green_time": color_signal("core_time_filled", Air.AirColor.GREEN),
	"set_purple_time": color_signal("core_time_set", Air.AirColor.PURPLE),
	"set_blue_time": color_signal("core_time_set", Air.AirColor.BLUE),
	"set_green_time": color_signal("core_time_set", Air.AirColor.GREEN),
	"remove_purple_time": color_signal("core_time_removed", Air.AirColor.PURPLE),
	"remove_blue_time": color_signal("core_time_removed", Air.AirColor.BLUE),
	"remove_green_time": color_signal("core_time_removed", Air.AirColor.GREEN),
	"add_max_purple_time": color_signal("core_max_time_added", Air.AirColor.PURPLE),
	"add_max_blue_time": color_signal("core_max_time_added", Air.AirColor.BLUE),	
	"add_max_green_time": color_signal("core_max_time_added", Air.AirColor.GREEN),
	"set_max_purple_time": color_signal("core_max_time_set", Air.AirColor.PURPLE),
	"set_max_blue_time": color_signal("core_max_time_set", Air.AirColor.BLUE),	
	"set_max_green_time": color_signal("core_max_time_set", Air.AirColor.GREEN),
