...
var weapon_data_path = "res://src/scenes/data/weapon_data.json"
var weapon_data_indices = {}
...
func _ready():
	...
	weapon_data = load_json_file(weapon_data_path)
	...
	weapon_data_indices = build_field_indices(weapon_data)
...
func get_data_and_indices_for_type(data_type: String) -> Array:
	...
	match data_type:
		...
		"goal":
			return [weapon_data, weapon_data_indices]
		"relic":
